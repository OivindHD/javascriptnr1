...
// Løsning i html: <script src="javascript.js"></script> 
...
// const navn = Øivind;
// let alder = 25;
// const erStudent = true;
// let farger = ["rød", "blå", "lilla"
...
Jeg prøvde meg frem så mye jeg kunne så spurte jeg tilslutt google om hjelp.
...
if (userName !== "" && userAge >= 18 && userIsBlocked === false) {
    userIsLoggedIn = true;
    goToPage = "/home";
    console.log("Velkommen " + userName + "! Du er logget inn og blir sendt til " + goToPage);
}       else {
